...
export declare class Controller extends EventEmitter {
    ...
    addInstance(instance: Instance, overwrite?: boolean): Promise<void>;
    ...
    removeInstance(instance: Instance): Promise<void>;
    ...
    stopInstance(instance: Instance, preventAutoRestart?: boolean): Promise<boolean>;
    init(): Promise<void>;
    start(): Promise<void>;
    private runInterval;
